...
I like turning confusing, repetitive, and error-prone engineering problems into simple, reusable tools.

In programming, simplicity and elegance are worth chasing. When a concept feels unusually complicated, it often means we have not found the right way to break it down yet.
...
| Project | What it is |
| --- | --- |
| [cwa-stack](https://github.com/whyfail/cwa-stack) | **The whole-stack engine (npm: cwa-stack)**: one command composes the five templates (React/Vue/Next.js/Nuxt × Spring Boot) into a single-repo, contract-driven full-stack project with real login and end-to-end verification. |
